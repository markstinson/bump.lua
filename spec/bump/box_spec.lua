...
describe('bump.box', function()
  ...
  describe('.containsPoint', function()
    it('returns true if a point is inside the box', function()
      assert.True(box.containsPoint(0,0,10,10, 5,5))
    end)
    it('returns false if a point is outside the box', function()
      assert.False(box.containsPoint(0,0,10,10, 15,15))
    end)
  end)

  describe('.getMinkowskyDiff', function()
    it('returns the Minkowsky difference of two given boxes', function()
      assert.same({-220,10,320,260}, {box.getMinkowskyDiff(10,60,150,120, 60,190,170,140)})
      assert.same({-222,-42,320,260}, {box.getMinkowskyDiff(8,112,150,120, 60,190,170,140)})
    end)
  end)
